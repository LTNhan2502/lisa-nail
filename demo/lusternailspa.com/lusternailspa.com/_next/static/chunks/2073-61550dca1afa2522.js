    ...
    [2073], {
                ...
                a = function() {
                    function e(e) {
                        var t = void 0 === e ? {} : e,
                            ...
                            s = void 0 === i ? o : i;
                        c(u(n), "`name` must be a string"), this._name = n, this._deletedRulePlaceholder = "#" + n + "-deleted-rule____{}", c("boolean" == typeof s, "`optimizeForSpeed` must be a boolean"), this._optimizeForSpeed = s, this._serverSheet = void 0, this._tags = [], this._injected = !1, this._rulesCount = 0;
        ...
        92922: (e, t, r) => {
            ...
            function i(e, t) {
                ...
                let i = !0 === t.header ? 0 : 1,
                    s = e.split(".")[i];
                if ("string" != typeof s) throw new n(`Invalid token specified: missing part #${i+1}`);
                try {
                    r = function(e) {
                        ...
                        try {
                            var r;
                            return r = t, decodeURIComponent(atob(r).replace(/(.)/g, (e, t) => {
        ...
        93435: (e, t, r) => {
            ...
            function d(e) {
                ...
                return void 0 !== s ? n.createElement(s.Consumer, null, e => t(e)) : t(i)
            }
        }
    }
]);