                ...
                l = function() {
                    function e(e) {
                        var t = void 0 === e ? {} : e,
                            ...
                            s = void 0 === i ? o : i;
                        d(u(r), "`name` must be a string"), this._name = r, this._deletedRulePlaceholder = "#" + r + "-deleted-rule____{}", d("boolean" == typeof s, "`optimizeForSpeed` must be a boolean"), this._optimizeForSpeed = s, this._serverSheet = void 0, this._tags = [], this._injected = !1, this._rulesCount = 0;
                    ...
                    return t.setOptimizeForSpeed = function(e) {
                            ...
                            if (d(u(e), "`insertRule` accepts only strings"), "undefined" == typeof window) return "number" != typeof t && (t = this._serverSheet.cssRules.length), this._serverSheet.insertRule(e, t), this._rulesCount++;
                            ...
                            t && d(u(t), "makeStyleTag accepts only strings as second parameter");
